...
class IphoneXsServices extends StatefulWidget {

  @override
  _IphoneXsServicesState createState() => _IphoneXsServicesState();
}

class _IphoneXsServicesState extends State<IphoneXsServices> {
  bool selected=true;
  isSelected(){
    setState(() {
      selected=!selected;
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: (){
                Navigator.of(context).pushNamed('IphoneXsDetails');
              },
              child: Text(
                'Next',
                style: TextStyle(
