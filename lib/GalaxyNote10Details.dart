...
class GalaxyNote10Details extends StatefulWidget {

  @override
  _GalaxyNote10DetailsState createState() => _GalaxyNote10DetailsState();
}

class _GalaxyNote10DetailsState extends State<GalaxyNote10Details> {
  bool selected1=true;
  bool selected2=true;
  originalSelected(){
    setState(() {
