...
class IphoneXsDetails extends StatefulWidget {

  @override
  _IphoneXsDetailsState createState() => _IphoneXsDetailsState();
}

class _IphoneXsDetailsState extends State<IphoneXsDetails> {
  bool selected1=true;
  bool selected2=true;
  originalSelected(){
    setState(() {
