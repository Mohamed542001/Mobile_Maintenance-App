...
class Iphone13Details extends StatefulWidget {

  @override
  _Iphone13DetailsState createState() => _Iphone13DetailsState();
}

class _Iphone13DetailsState extends State<Iphone13Details> {
  bool selected1=true;
  bool selected2=true;
  originalSelected(){
    setState(() {
