...
class PocoX3Services extends StatefulWidget {

  @override
  _PocoX3ServicesState createState() => _PocoX3ServicesState();
}

class _PocoX3ServicesState extends State<PocoX3Services> {
  bool selected=true;
  isSelected(){
    setState(() {
      selected=!selected;
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: (){
                Navigator.of(context).pushNamed('PocoX3Details');
              },
              child: Text(
                'Next',
                style: TextStyle(
