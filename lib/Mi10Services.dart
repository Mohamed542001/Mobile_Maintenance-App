...
class Mi10Services extends StatefulWidget {

  @override
  _Mi10ServicesState createState() => _Mi10ServicesState();
}

class _Mi10ServicesState extends State<Mi10Services> {
  bool selected=true;
  isSelected(){
    setState(() {
      selected=!selected;
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: (){
                Navigator.of(context).pushNamed('Mi10Details');
              },
              child: Text(
                'Next',
                style: TextStyle(
