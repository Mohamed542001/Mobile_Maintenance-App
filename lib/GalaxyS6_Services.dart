...
class GalaxyS6Services extends StatefulWidget {

  @override
  _GalaxyS6ServicesState createState() => _GalaxyS6ServicesState();
}

class _GalaxyS6ServicesState extends State<GalaxyS6Services> {
  bool selected=true;
  isSelected(){
    setState(() {
      selected=!selected;
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: (){
                Navigator.of(context).pushNamed('GalaxyS6Details');
              },
              child: Text(
                  'Next',
                  style: TextStyle(
